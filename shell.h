...
char *_concat(char *tmp, char **av, char *tok);/*This function is concatenating the strings.*/
...
char *_memset(char *s, char b, unsigned int n);/*This function is used to fill the first n bytes of the memory area pointed to by s with the constant byte b.*/
